...
class sspmod_multiauthsql_Auth_Source_MultiAuthSql extends SimpleSAML_Auth_Source {
	 ...
	 */
	const STAGEID = 'sspmod_multiauthsql_Auth_Source_MultiAuthSql.StageId';

	/**
	 * The key where the sources is saved in the state.
	 */
	const SOURCESID = 'sspmod_multiauthsql_Auth_Source_MultiAuthSql.SourceId';
	...
	public function __construct($info, $config) {
		...
		$this->db = new MultiAuthSqlDb($this->authId, $config);

		$this->sources = $this->db->fetchAuthSources();
	}
	...
	public function authenticate(&$state) {
		...
		$url = SimpleSAML_Module::getModuleURL('multiauthsql/selectsource.php');
